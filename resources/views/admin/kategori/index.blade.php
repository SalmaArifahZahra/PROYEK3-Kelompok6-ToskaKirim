                ...
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-700">
                            <a href="{{ route('admin.kategori.index', array_merge(request()->except(['sort_by', 'sort_order']), ['sort_by' => 'nama_kategori', 'sort_order' => $sortBy === 'nama_kategori' && $sortOrder === 'asc' ? 'desc' : 'asc'])) }}" 
