...
<div class="space-y-6">
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 text-sm text-gray-700">
            ...
            <li class="text-2xl font-bold text-gray-800">Edit Kategori</li>
        </ol>
    </nav>
            ...
            <form action="{{ route('admin.kategori.update', $kategori->id_kategori) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex gap-x-8 gap-y-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <!-- Use Sub-Kategori management for children -->
                    </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="w-64 h-64 bg-gray-100 rounded-lg flex items-center justify-center mb-3 overflow-hidden">
                                <img id="preview-image"
                                     src="{{ $kategori->foto ? asset($kategori->foto) : '' }}"
                                     alt="Preview"
                                     class="{{ $kategori->foto ? '' : 'hidden' }} w-full h-full object-contain">
                                <div id="preview-placeholder" class="text-gray-400 {{ $kategori->foto ? 'hidden' : '' }}">
