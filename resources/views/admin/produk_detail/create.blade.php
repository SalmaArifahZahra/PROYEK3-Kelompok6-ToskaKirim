...
<div class="space-y-6">
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 text-sm text-gray-700">
            ...
            <li class="text-2xl font-bold text-gray-800">Tambah Varian Produk</li>
        </ol>
    </nav>
    ...
    <div class="flex justify-center">
        <div class="bg-white rounded-lg shadow-md p-8 inline-block">
            <h2 class="text-2xl font-semibold text-[#5BC6BC] mb-8">Varian Produk Baru</h2>

        <form action="{{ route('admin.produk.detail.store', $produk->id_produk) }}" method="POST" enctype="multipart/form-data">
            @csrf
