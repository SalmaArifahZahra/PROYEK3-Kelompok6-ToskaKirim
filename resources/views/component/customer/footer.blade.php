<footer class="bg-[#5BC6BC] text-white mt-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-10 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        <div>
        ...
        <div class="flex justify-center md:justify-end">
            <iframe
                ...
                allowfullscreen=""
                loading="lazy"
                class="rounded-lg shadow-md w-full h-40 sm:w-[260px] sm:h-[160px]">
            </iframe>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 pb-6 flex flex-col md:flex-row justify-between items-center text-sm">
        <p class="text-center md:text-left">© {{ date('Y') }} ToskaKirim. All rights reserved.</p>
